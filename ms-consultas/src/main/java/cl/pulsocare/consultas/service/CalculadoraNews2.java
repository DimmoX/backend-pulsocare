 ...
 *
 * Adaptacion: se usan los 5 signos que PulsoCare captura (FR, SpO2, temperatura, PAS,
 * FC). NEWS2 no usa la presion diastolica. Los parametros que la plataforma no mide
 * —consciencia y oxigeno suplementario— se asumen normales (0 puntos); ver PuntajeNews2.
 */
